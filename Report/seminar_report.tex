...
1.{\textbf{Real-Time Event Detection}}\\
...
2.{\textbf{Buffered Video Recording}}\\
...
3.{\textbf{GStreamer-Based Video Encoding}}\\
...
4.{\textbf{Modular Component Design}}\\
...
6.{\textbf{Android Application Integration}}\\
...
7.{\textbf{End-to-End Workflow Integration}}\\
...
\section{COSENS: Collaborative and opportunistic sensing of road events by vehicles' cameras}
...
\hline
Sprint 5 & 02 Mar -- 20 Mar 2026 & Testing, Documentation \& Final Review &  Completed  \\
\hline
\end{longtable}
...
\begin{itemize}
  \item {Event Test App:}A simulation tool developed for triggering artificial events such as honk and brake events. This was essential during development and testing, allowing deterministic input and verification of system behaviour.
  \item {Person Event Detection:}Implemented as a Python script using OpenCV, this module performs real-time person detection using live video feed or frames captured from the camera. Upon detecting a suspicious presence, it generates a person event and sends it to the Event Manager.
  \end{itemize}
...
\begin{itemize}
  ...
  \item  Iterative refinements were performed within modules while following the Agile/Scrum approach, such as optimizing the circular queue for memory usage and frame timing.
