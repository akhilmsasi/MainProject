...
Scrum organises work into time-boxed iterations called \textbf{sprints}. At the start of each sprint, the team selects a set of backlog items to deliver. During the sprint, daily progress is tracked and blockers are addressed. At the end of each sprint, a working increment is demonstrated and a retrospective is held to identify improvements for the next sprint.
...
The project was executed over \textbf{five monthly sprints}, each aligned to the academic calendar with a defined goal, planned activities, and a measurable status.

\subsection{Sprint 1 -- November: System Integration \& Database Architecture}
...
\subsection{Sprint 2 -- December: Network Streaming \& Event Logic Refinement}
...
\subsection{Sprint 3 -- January: Integration \& Testing}
...
\subsection{Sprint 4 -- February: Collaborative Logic \& Performance Testing}
...
\subsection{Sprint 5 -- March: Testing, Documentation \& Final Review}
...
\begin{longtable}{|p{1.4cm}|p{2.6cm}|p{6.8cm}|p{2.4cm}|}
\hline
\textbf{Sprint} & \textbf{Month} & \textbf{Focus Area} & \textbf{Status} \\
\hline
Sprint 1 & November & System Integration \& Database Architecture & Completed \\
\hline
Sprint 2 & December & Network Streaming \& Event Logic Refinement & Completed \\
\hline
Sprint 3 & January & Integration \& Testing & Completed \\
\hline
Sprint 4 & February & Collaborative Logic \& Performance Testing & In Progress \\
\hline
Sprint 5 & March & Testing, Documentation \& Final Review & In Progress \\
\hline
\end{longtable}
